...
class T5Wiki(Abstractive):
    def __init__(self):
        super().__init__()
        self.model = T5ForConditionalGeneration.from_pretrained("deep-learning-analytics/wikihow-t5-small").to(self.device)
        self.tokenizer = T5Tokenizer.from_pretrained("deep-learning-analytics/wikihow-t5-small")
